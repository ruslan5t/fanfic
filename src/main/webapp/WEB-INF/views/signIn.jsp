...
<body>
	...
	<div class="container">
		<div class="col-xs-12 col-sm-9">
			...
			<div class="well">
           		<form class="bs-example form-horizontal" method="post" action="${pageContext.servletContext.contextPath}/j_spring_security_check">
                	<fieldset>
                  		<legend>Login</legend>
                  		<div class="form-group">
                    		...
                    		<div class="col-lg-10">
                      			<input id="j_username" name="j_username" type="text" placeholder="${usernameTranslate}" maxlength="30" class="form-control"/>
                    		</div>
                  		</div>
                  		<div class="form-group">
                    		...
                    		<div class="col-lg-10">
                      			<input id="j_password" name="j_password" type="password" placeholder="${passwordTranslate}" maxlength="30" class="form-control"/>
